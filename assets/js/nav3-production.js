(() => {
  ...
  const schoolActive = () => ['/dahab/safety', '/dahab/windsurf-kids', '/dahab/equipment', '/dahab/team', '/dahab/how-to-get', '/dahab/where-to-stay'].some((href) => current === href || current.startsWith(href + '/'));
